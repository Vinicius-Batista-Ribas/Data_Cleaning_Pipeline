...
def infos_auxiliares(df):
    ...
    with open("Example_2/logs/infos_auxiliares.txt", "w", encoding="utf-8") as f:
...
def relatorio_qualidade(df, df_original=None, path="Example_2/logs/relatorio_qualidade.txt"):
